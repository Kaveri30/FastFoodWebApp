import { AfterViewInit, ElementRef, EventEmitter, OnChanges, OnDestroy, SimpleChanges, ChangeDetectorRef } from '@angular/core';
...
export declare class NgxPaypalComponent implements OnChanges, OnDestroy, AfterViewInit {
     ...
     */
    private payPal;
    constructor(paypalScriptService: PayPalScriptService, cdr: ChangeDetectorRef);
